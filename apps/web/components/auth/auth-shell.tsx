 ...
 * only — a calm, indigo-forward field with a floating white card; the forms + all auth logic live in the
 * pages. The decorative field is built from design tokens (a soft indigo gradient + brand-tinted blobs),
...
export function AuthShell({
  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-background p-6">
      {/* Tokenized decorative indigo field — no assets. */}
      <div
        aria-hidden
