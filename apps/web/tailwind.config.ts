...
// tailwindcss-animate is a plain JS plugin without bundled types; require dodges the
// missing-declaration error under `tsc --noEmit`.
// eslint-disable-next-line @typescript-eslint/no-var-requires
const animate = require('tailwindcss-animate');

// hrorg.in theme. Tailwind PINNED at v3.4 (deliberate — do not drift to v4).
